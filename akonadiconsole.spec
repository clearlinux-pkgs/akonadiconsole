...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/akonadiconsole-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/akonadiconsole-24.12.3.tar.xz.sig
...
%setup -q -n akonadiconsole-24.12.3
cd %{_builddir}/akonadiconsole-24.12.3
pushd ..
cp -a akonadiconsole-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742581353
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadiconsole.so.6.3.3
/usr/lib64/libakonadiconsole.so.6
/usr/lib64/libakonadiconsole.so.6.3.3
