...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/akonadiconsole-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/akonadiconsole-22.12.3.tar.xz.sig
...
%prep
%setup -q -n akonadiconsole-22.12.3
cd %{_builddir}/akonadiconsole-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677857893
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadiconsole.so.5.22.3
