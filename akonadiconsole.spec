...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akonadiconsole-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/akonadiconsole-22.08.0.tar.xz.sig
...
%prep
%setup -q -n akonadiconsole-22.08.0
cd %{_builddir}/akonadiconsole-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661787660
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadiconsole.so.5.21.0
