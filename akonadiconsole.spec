...
Version  : 24.02.2
Release  : 69
URL      : https://download.kde.org/stable/release-service/24.02.2/src/akonadiconsole-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/akonadiconsole-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/akonadiconsole-24.02.2.tar.xz.sig
...
%setup -q -n akonadiconsole-24.02.2
cd %{_builddir}/akonadiconsole-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712960506
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadiconsole.so.6.0.2
/usr/lib64/libakonadiconsole.so.6
/usr/lib64/libakonadiconsole.so.6.0.2
