...
Version  : 22.08.1
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.08.1/src/akonadiconsole-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/akonadiconsole-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/akonadiconsole-22.08.1.tar.xz.sig
...
%prep
%setup -q -n akonadiconsole-22.08.1
cd %{_builddir}/akonadiconsole-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662788447
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadiconsole.so.5.21.1
