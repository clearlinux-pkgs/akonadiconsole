...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/akonadiconsole-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/akonadiconsole-24.12.0.tar.xz.sig
...
%setup -q -n akonadiconsole-24.12.0
cd %{_builddir}/akonadiconsole-24.12.0
pushd ..
cp -a akonadiconsole-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735393310
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadiconsole.so.6.3.0
/usr/lib64/libakonadiconsole.so.6
/usr/lib64/libakonadiconsole.so.6.3.0
