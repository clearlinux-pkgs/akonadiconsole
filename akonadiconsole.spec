...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/akonadiconsole-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/akonadiconsole-22.12.0.tar.xz.sig
...
%prep
%setup -q -n akonadiconsole-22.12.0
cd %{_builddir}/akonadiconsole-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670787314
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadiconsole.so.5.22.0
