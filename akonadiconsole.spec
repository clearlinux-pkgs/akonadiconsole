...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/akonadiconsole-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/akonadiconsole-22.12.1.tar.xz.sig
...
%prep
%setup -q -n akonadiconsole-22.12.1
cd %{_builddir}/akonadiconsole-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673449806
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadiconsole.so.5.22.1
